...
<body>
    <form action="" method="get">
        ...
        <select id="style" name="style">
            ...
            <option value="style 1" <?php echo $style == "style1" ? "selected" : ""; ?>>Style 1</option>
            <option value="style 2" <?php echo $style == "style2" ? "selected" : ""; ?>>Style 2</option>
            <option value="style 3" <?php echo $style == "style3" ? "selected" : ""; ?>>Style 3</option>
        </select>
